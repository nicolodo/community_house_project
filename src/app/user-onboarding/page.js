      ...
      <form action={handleSubmitNewUser}>
        <div className="flex flex-col gap-2 border">
          ...
          <select name="Street_name">
            <option name={"west Street"}>West Street</option>
            <option name={"East Street"}>East Street</option>
            <option name={"South Street"}>South Street</option>
            <option name={"North Street"}>North Street</option>
          </select>
